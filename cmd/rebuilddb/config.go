...
var (
	...
	//rebuilddbHomeDir            = cdrutil.AppDataDir("rebuilddb", false)
	...
	defaultDBUser      = "cdrata"
	defaultDBPass      = "bananas"
	defaultDBTableName = "cdrata"
...
func cleanAndExpandPath(path string) string {
	...
	if strings.HasPrefix(path, "~") {
		homeDir := filepath.Dir(cdrHomeDir)
...
// const (
//     defaultDBTableName = "cdrata"
//     defaultDBUserName = "cdrata"
//     defaultDBPass = "cdrpassword"
//     defaultDBFileName = "cdrata.sqlt.dat"
//     defaultDBHostPort = "127.0.0.1:3660"
// )

// type configuration struct {
//     DaemonHostPort string `json:"cdrhost"`
//     DaemonUser string `json:"cdruser"`
//     DaemonPass string `json:"cdrpass"`
