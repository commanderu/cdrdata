...
1. Fork the repository on GitHub.  Just click the little Fork button at https://github.com/commanderu/cdrata
2. Clone your newly forked cdrata repository

```sh
git clone git@github.com:my-user-name/cdrata.git
```
...
At the [main cdrata repo page](https://github.com/commanderu/cdrata) (not your fork) you may find a button suggesting that you might want to create a PR from a branch you just pushed. "Compare & pull request" it will say on a big green button. Click it and it will start form to open a new pull request. Always:
