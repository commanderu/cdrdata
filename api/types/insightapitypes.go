...
type InsightAddress struct {
	...
	Transactions []*cdrjson.SearchRawTransactionsResult `json:"items,omitempty"`
}
...
type InsightAddressInfo struct {
	...
	TotalReceived    cdrutil.Amount `json:"totalReceived"`
	TotalSent        cdrutil.Amount `json:"totalSent"`
	Unspent          cdrutil.Amount `json:"balance"`
